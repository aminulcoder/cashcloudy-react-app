      ...
      <div className="px-6 md:px-12 lg:px-20 xl:px-32 ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 font-Inter lg:grid-cols-3 gap-3 lg:gap-6 2xl:gap-6">
          ...
          <div className="border rounded-3xl lg:px-5   px-12 space-y-4 py-6 h-72 lg:h-64 xl:h-72 2xl:h-96 sm:h-80 shadow-md">
            <img
              src="/src/assets/Feature/coins-hand.svg"
          ...
          <div className="border rounded-3xl lg:px-5  px-6 space-y-4 py-6 h-72 lg:h-64 xl:h-72 2xl:h-96  sm:h-80 shadow-md">
            <img
              src="/src/assets/Feature/monitor-01.svg"
              className="border rounded-lg  p-3 sm:p-4 lg:p-3 bg-gray-100 lg:h-12 lg:w-12 2xl:h-16 2xl:w-16 sm:w-16 sm:h-16"
              alt=""
            />
            <h3 className="text-start text-2xl sm:text-5xl md:text-2xl  lg:text-xl xl:text-3xl 2xl:text-4xl font-bold text-[#101828]">
          ...
          <div className="border rounded-3xl lg:px-5  px-6 space-y-4 py-6 h-72 lg:h-64 xl:h-72 2xl:h-96 sm:h-80 shadow-md">
            <img
              src="/src/assets/Feature/bell-02.svg"
              className="border rounded-lg  p-3 sm:p-4 lg:p-3 bg-gray-100 lg:h-12 lg:w-12 2xl:h-16 2xl:w-16 sm:w-16 sm:h-16"
              alt=""
            />
            <h3 className="text-start text-2xl sm:text-5xl md:text-2xl  lg:text-xl xl:text-3xl 2xl:text-4xl font-bold text-[#101828]">
          ...
          <div className="border rounded-3xl lg:px-5 px-6 space-y-4 py-6 h-72 lg:h-64 xl:h-72 2xl:h-96 sm:h-80 shadow-md">
            <img
              src="/src/assets/Feature/credit-card-up.svg"
              className="border rounded-lg  p-3 sm:p-4 lg:p-3 bg-gray-100 lg:h-12 lg:w-12 2xl:h-16 2xl:w-16 sm:w-16 sm:h-16"
              alt=""
            />
          ...
          <div className="border rounded-3xl lg:px-5 px-6 space-y-4 py-6 h-72 lg:h-64 xl:h-72 2xl:h-96 sm:h-80 shadow-md">
            <img
              src="/src/assets/Feature/line-chart-up-02.svg"
              className="border rounded-lg  p-3 sm:p-4 lg:p-3 bg-gray-100 lg:h-12 lg:w-12 2xl:h-16 2xl:w-16 sm:w-16 sm:h-16"
              alt=""
            />
            <h3 className="text-start text-[#101828] text-2xl sm:text-5xl md:text-2xl  lg:text-xl xl:text-3xl 2xl:text-4xl font-bold">
          ...
          <div className="border rounded-3xl lg:px-5 px-7 space-y-4 py-6 h-72 lg:h-64 xl:h-72 2xl:h-96 sm:h-80 shadow-md">
            <img
              src="/src/assets/Feature/Frame 2 (1).svg"
              className="border rounded-lg  p-3 sm:p-4 lg:p-0 bg-gray-100 2xl:h-16 2xl:w-16 lg:h-12 lg:w-12 sm:w-16 sm:h-16 "
              alt=""
            />
            <h3 className="text-start text-2xl sm:text-5xl md:text-2xl  lg:text-xl xl:text-3xl 2xl:text-4xl font-bold text-[#101828]">
