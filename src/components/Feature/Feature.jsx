      ...
      <div className="grid grid-cols-12 gap-6">
        <div className="col-span-4 ">
          <div className="border  rounded-xl px-6 space-y-4 py-6">
            <img src="/src/assets/Feature/Icon1.png" className='border rounded-lg p-4 bg-gray-100' alt="" />
        ...
        <div className="col-span-4 ">
          <div className="border  rounded-xl px-6 space-y-4 py-6">
            <img src="/src/assets/Feature/monitor-02.png" className='border rounded-lg p-4 bg-gray-100' alt=""  />
        ...
        <div className="col-span-4 ">
          <div className="border  rounded-xl px-6 space-y-4 py-6">
            <img src="/src/assets/Feature/bell-03.png" className='border rounded-lg p-4 bg-gray-100' alt=""  />
        ...
        <div className="col-span-4 ">
          <div className="border  rounded-xl px-6 space-y-4 py-6">
            <img src="/src/assets/Feature/credit-card-up-04.png" className='border rounded-lg p-4 bg-gray-100' alt=""  />
        ...
        <div className="col-span-4 ">
          <div className="border  rounded-xl px-6 space-y-4 py-6">
            <img src="/src/assets/Feature/Icon-05.png" className='border rounded-lg p-4 bg-gray-100' alt=""  />
        ...
        <div className="col-span-4 ">
          <div className="border  rounded-xl px-6 space-y-4 py-6">
            <img src="/src/assets/Feature/headphones-06.png" className='border rounded-lg p-4 bg-gray-100' alt=""  />
