...
const StaticAccordion = () => {
  ...
  return (
    <div className="px-4 md:max-w-lg lg:max-w-2xl xl:max-w-4xl  2xl:max-w-6xl py-12  mx-auto">

      <h2 className="text-center font-bold text-2xl md:text-5xl xl:text-6xl md:py-3 font-Inter text-[#101828]">FAQs</h2>
      {/* Item 1 */}
