...
const Amount = () => {
  return (
    <div>
      <h2 className="text-center text-gray-950 font-semibold text-3xl pb-3">
        How much are you sending?
      </h2>

      <p className="bg-slate-200 rounded-3xl inline-block px-4 py-2">
        (1 USD = 119.50 BDT)
      </p>
      <div className="">
        <div>
      ...
      <p className="text-start py-1">
        You have <strong>100 USD </strong>available in your balance{" "}
      </p>
