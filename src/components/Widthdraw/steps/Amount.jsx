...
const Amount = () => {
  return (
    <div>
    <h2 className='text-center text-gray-950 font-semibold  text-[21px] sm:text-3xl  pb-3'>How much are you sending?</h2>

    <p className='bg-slate-200 rounded-3xl font-semibold inline-block px-3 sm:px-6 py-1 sm:py-2'>(1 USD = 119.50 BDT)</p>
    <div className="">
      <div>
    ...
    <p className="text-start text-[#475467] text-sm sm:text-lg py-1">You have <strong>100 USD </strong>available in your balance </p>
    <div className="flex justify-between py-3">
      <p className='text-base sm:text-lg font-medium text-[#475467]'>Includes fees</p>
      <span className='text-base sm:text-lg font-semibold text-gray-950'>3.75 USD</span>
    </div>
    <div className="flex justify-between py-3">
      <p className='text-sm sm:text-lg font-medium text-[#475467]'>Should arrive</p>
      <span className='text-sm sm:text-lg font-bold text-gray-950'>by Sunday, 1 January</span>
    </div>
