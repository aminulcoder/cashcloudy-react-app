...
const  HeroArea = () => {
  return (
    <section className="bg-[#6941C6] sm:min-h-screen flex flex-col items-center  px-3 sm:px-8 md:px-12 lg:px-24 xl:px-48 relative">
      <div className="relative z-50 pb-12 sm:pb-44">
        {/* Hero Heading */}
      ...
      <div className="hidden sm:block">
        ...
        <div className="absolute inset-0 w-full h-full flex items-end justify-between z-20">
          ...
          <div
            className="h-[400px] w-[750px] bg-cover bg-no-repeat bg-center opacity-50"
            style={{
        ...
        {/* Foreground Images */}
        <div className="absolute z-30 inset-0 w-full h-full flex items-end  space-x-24 px-6 sm:px-12 xl:px-60  pt-10 lg:px-24  ">
          ...
          <div className="relative w-1/2 flex justify-center">
            <img
              ...
              className="w-[300px] md:w-[660px] lg:w-[450px] object-contain"
            />
          </div>
        </div>
      </div>
