...
const Recipient = () => {
  return (
    <div>
      ...
      <p className='text-start text-gray-500 text-base sm:text-xl py-6 px-6'>Existing recipients</p>
      <div className='space-y-4'>
        <div className="flex justify-between items-center">
          <div className="flex items-center sm:px-3">
            ...
            <div className="px-3">
              <h4 className=" text-xl sm:text-3xl text-gray-800 font-semibold">Existing recipients</h4>
              <p className='text-gray-500 text-start text-xs'>BDT account ending in 8001</p>
            </div>
          </div>
