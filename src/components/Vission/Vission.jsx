      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 2xl:gap-3 ">
        ...
        <div className=" lg:col-span-6 space-y-1 sm:space-y-6  lg:space-y-0 text-start">
          ...
          <div className="flex items-start space-x-4 sm:sp py-3  sm:py-0 md:py-6 lg:pt-4 xl:pt-10">
            ...
            <img
              src="/src/assets/Vission/Icon (1).svg"
              className="  p-3 sm:p-4 lg:p-3  lg:h-12 lg:w-12 2xl:h-16 2xl:w-16 sm:w-16 sm:h-16"
              alt=""
            />
            <div>
              <h4 className=" text-lg sm:text-3xl md:text-4xl lg:text-2xl xl:text-2xl font-Inter font-medium 2xl:text-4xl  text-[#101828]">
                Register for free
              </h4>
              <p className=" text-justify  sm:text-xl md:text-xl lg:text-base xl:text-base 2xl:text-2xl font-normal font-Inter text-xs  text-[#101828]">
                Sign up online or in our app for free. All you need is an  <br />email
          ...
          <div className="flex items-start space-x-4">
            <img
              src="/src/assets/Vission/paper plane.svg"
              className="  p-3 sm:p-4 lg:p-3  lg:h-12 lg:w-12 2xl:h-16 2xl:w-16 sm:w-16 sm:h-16"
              alt=""
            />
            <div>
              <h4 className="text-lg sm:text-3xl lg:text-2xl  2xl:text-4xl  text-[#101828] xl:text-2xl font-Inter font-medium ">
                Send Payment Request
              </h4>
              <p
                className=" text-justify text-xs xl:text-base
font-normal font-Inter sm:text-xl md:text-xl lg:text-base  2xl:text-2xl text-[#101828] "
              >
                Sign up online or in our app for free. All you need is an <br /> email
                address, or a Google or Facebook account.
              </p>
          ...
          <div className="flex items-center space-x-4 py-6 lg:py-3 pb-8 sm:pb-16 lg:pb-8 xl:pb-24 2xl:pb-20">
            <img
              src="/src/assets/Vission/cloude arrow.svg"
              className="  p-3 sm:p-4 lg:p-3  lg:h-12 lg:w-12 2xl:h-16 2xl:w-16 sm:w-16 sm:h-16"
              alt=""
            />
            <div>
